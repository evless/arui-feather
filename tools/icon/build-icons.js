...
const removeDublicates = require('./utils').removeDublicates;
const getFilename = require('./utils').getFilename;
const getDirectories = require('./utils').getDirectories;
const getTemplate = require('./utils').getTemplate;
const ICON_REGEXP = require('./utils').ICON_REGEXP;
...
const createComponents = () => new Promise((resolve) => {
    icons.forEach((item) => {
        ...
        if (!fs.exists(item.cssFile)) fs.writeFileSync(item.cssFile, COPYRIGHT);
